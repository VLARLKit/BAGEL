...
# --- 随机亮度（变暗） ---
class RandomBrightnessPIL:
    def __init__(self, min_factor=0.3, max_factor=1.0):
...
transform_pil = ComposePIL([
    RandomBrightnessPIL(0.6, 1.4),   # 随机变暗
    RandomBlurPIL(p=0.5, radius_range=(0.5, 2.0)),  # 随机模糊
    RandomNoisePIL(std=0.05, p=0.5),  # 随机加噪
])